...
import pt.isel.mpd14.probe.BindStringToCaps;
...
public class BinderTest extends TestCase{
    ...
    public void test_bind_to_student_properties_and_fields() throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, ParseException{
        ...
        */
        ...
        Act
        */
        Student s = new Binder<>(Student.class, new BindProp<>(Student.class), new BindField<Student>())
                .bindTo(v);
        /*
        Assert
        */
    ...
    public void test_bind_fields_apply_stringtocaps_values() throws Exception
    {
        /*
         Arrange
        */
        ...
        /*
          Act
        */
        StudentDto s2 = new Binder<>(StudentDto.class, new BindStringToCaps<StudentDto>(new BindField<StudentDto>()))
                .bindTo(v);
        System.out.println(s2);
        /*
          Assert
        */
        Assert.assertEquals(0, s2.id);
        Assert.assertEquals("MY NAME", s2.name);
        Assert.assertEquals(v.get("birthDate"), s2.birthDate);
